...
class Elgentos_RelatedBundles_Block_Adminhtml_Catalog_Product_Edit_Tab_Custom extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * Set grid params
     *
    ...
    {
        $collection = Mage::getModel('catalog/product_link')->useRelatedBundles()
